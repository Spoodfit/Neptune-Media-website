...
function toggleTier(form,box){const tier=box.closest('.v147-tier');if(!tier)return;tier.classList.toggle('is-hidden-tier',!box.checked);tier.setAttribute('aria-disabled',box.checked?'false':'true')}
