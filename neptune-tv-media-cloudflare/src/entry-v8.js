...
async function injectWorkflowAssets(response, pathname) {
  ...
  if (clientPaths.has(pathname)) {
    if (!body.includes('/espace-client/workflow-v45.css')) body = body.replace('</head>', '<link rel="stylesheet" href="/espace-client/workflow-v45.css?v=2"></head>');
    if (!body.includes('/espace-client/workflow-v45.js')) body = body.replace('</body>', '<script type="module" src="/espace-client/workflow-v45.js?v=2"></script></body>');
  }
  if (studioPaths.has(pathname)) {
    if (!body.includes('/studio/clients-workflow-v37.css')) body = body.replace('</head>', '<link rel="stylesheet" href="/studio/clients-workflow-v37.css?v=2"></head>');
    ...
    if (!body.includes('/studio/clients-workflow-v37.js')) body = body.replace('</body>', '<script type="module" src="/studio/clients-workflow-v37.js?v=2"></script></body>');
  }
  const headers = new Headers(response.headers);
  headers.delete('Content-Length');
