...
const entry=read('src/entry-v46.js');
...
check('active v46 intercepts family saves before legacy v143',entry.includes('handleCatalogFamilyUpdateV169Store(this,request)'));
check('active v46 injects effective visibility UX',entry.includes('studio-catalog-effective-visibility-v169.js')&&entry.includes('X-Neptune-Catalog-Effective-Visibility'));
...
console.log('Catalog effective visibility + safe hierarchy update v169 verified.');
