...
const checks = [
  ...
  ['src/entry-v33.js', ["from './entry-v32.js'",'/api/admin/webtv/state','WebTvEncoder']],
...
console.log('Simple client journey v92 preserved through Drive upload v94 and Web TV v33: 8 passage steps, multi-passage isolation, Stripe, supplier SLA, J-15, Google scheduling and Drive automation');
