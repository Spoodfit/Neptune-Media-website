      ...
      <div className="container-neptune">
        ...
        <div className="glow-border mx-auto mt-8 max-w-5xl overflow-hidden rounded-3xl bg-gradient-to-b from-[#11274ce0] via-[#101436e6] to-[#2f1346c7]">
          <div className="grid gap-0 md:grid-cols-[1.05fr_0.95fr] md:items-stretch">
            <div className="relative min-h-[240px] md:min-h-[360px]"><Image src="/assets/posters/studio-wide.webp" alt="Plateau Neptune utilisé pour le bonus Connexio" fill className="object-cover object-center" sizes="(max-width: 768px) 100vw, 55vw" priority={false} /></div>
