const RELEASE='neptune-studio-zero-flash-20260823-v139';
...
const NAVIGATION_GUARD='/studio/studio-navigation-guard-v138.js?v=2';
...
export async function injectStudioZeroFlashV136(response,pathname){
  ...
  body=body.replace(/<\/body>/iu,`<script type="module" src="${CANONICAL_SHELL}" data-neptune-canonical-shell="v138"></script><script type="module" src="${NAVIGATION_GUARD}" data-neptune-navigation-guard="v139"></script><script type="module" src="${SHELL_JS}" data-neptune-zero-flash="v136"></script></body>`);
