...
for(const needle of ["studio-catalog-user-reliability-v146.js?v=1","X-Neptune-Catalog-Cockpit','v146"])if(!entry.includes(needle))throw new Error(`entry contract missing: ${needle}`);
