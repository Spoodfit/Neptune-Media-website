...
const VISUAL_CSS='/espace-client/client-visual-coherence-v118-2.css?v=3';
const POLISH_CSS='/espace-client/client-ux-polish-v118-3.css?v=1';
const UX_V1184_CSS='/espace-client/client-ux-v118-4.css?v=1';
const CATALOG_HOVER_CSS='/espace-client/client-catalog-hover-v118-7.css?v=2';
...
const VISUAL_JS='/espace-client/client-visual-coherence-v118-2.js?v=3';
const UX_V1184_JS='/espace-client/client-ux-v118-4.js?v=1';
const CATALOG_INTERACTION_JS='/espace-client/client-catalog-interaction-v118-7.js?v=1';
...
async function injectClientExperience(response,pathname=''){
  ...
  body=body.replace(/<link\b[^>]*href=["'][^"']*\/espace-client\/(?:client-experience-v117|client-command-center-v118|client-catalog-rail-v118|client-visual-coherence-v118-2|client-ux-polish-v118-3|client-ux-v118-4|client-catalog-hover-v118-7)\.css[^"']*["'][^>]*>\s*/giu,'');
  body=body.replace(/<script\b[^>]*src=["'][^"']*\/espace-client\/(?:client-experience-v117|client-command-center-v118(?:-1)?|client-preparation-context-v118|client-passage-deeplink-v118|client-visual-coherence-v118-2|client-ux-v118-4|client-catalog-interaction-v118-(?:6|7)|client-calendar-chrome-v118-4-1)\.js[^"']*["'][^>]*>\s*<\/script>\s*/giu,'');
  ...
  body=body.replace('</head>',`<link rel="stylesheet" href="${CLIENT_CSS}"><link rel="stylesheet" href="${COMMAND_CSS}"><link rel="stylesheet" href="${CATALOG_RAIL_CSS}"><link rel="stylesheet" href="${VISUAL_CSS}"><link rel="stylesheet" href="${POLISH_CSS}"><link rel="stylesheet" href="${UX_V1184_CSS}"><link rel="stylesheet" href="${CATALOG_HOVER_CSS}"></head>`);
  const calendarChrome=pathname.startsWith('/espace-client/calendrier')?`<script type="module" src="${CALENDAR_CHROME_JS}"></script>`:'';
  body=body.replace('</body>',`<script type="module" src="${CLIENT_JS}"></script><script type="module" src="${COMMAND_JS}"></script><script type="module" src="${PREPARATION_CONTEXT_JS}"></script><script type="module" src="${PASSAGE_JS}"></script><script type="module" src="${VISUAL_JS}"></script><script type="module" src="${UX_V1184_JS}"></script><script type="module" src="${CATALOG_INTERACTION_JS}"></script>${calendarChrome}</body>`);
...
async function augmentRelease(response){
  ...
  return new Response(JSON.stringify({...current,clientExperience:RELEASE,clientExperienceBase:BASE_CLIENT_EXPERIENCE,clientCommandCenter:'compact-selection-persistent-collapsible-stage-details-v118.4',clientPreparation:'step-local-reading-ack-v118',clientPreparationBridge:'v77-state-context-bridge-v118.3.1',clientCatalogVisuals:'studio-synced-v118.7',clientCatalogLayout:'city-first-horizontal-rail-v118.2',clientCatalogHover:'paint-only-no-hitbox-motion-v118.7',clientVisualCoherence:'icon-halo-selected-stage-v118.4',clientUxPolish:'stable-stage-hitboxes-preloaded-preparation-compact-support-v118.3',clientLibraryLayout:'full-width-responsive-long-short-workspaces-v118.4',clientContentPlanning:'week-month-grounded-video-identity-no-blocking-ai-v118.4',clientCalendarChrome:'persistent-publication-planner-copy-v118.4.1',clientContentReuse:'instant-grounded-file-identity-no-ai-wait-v118.4',clientDirectBooking:DIRECT_BOOKING_RELEASE,clientCatalogInteraction:CATALOG_INTERACTION_RELEASE,clientLoadingStates:'skeleton-error-retry-reduced-motion-v117'}),{
