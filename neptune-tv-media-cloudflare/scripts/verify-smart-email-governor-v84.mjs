...
expect(entryV33, "from './entry-v32.js'", 'entry-v33 Web TV ne prolonge pas la chaîne v94/v92/v91/v90 sans casser v84');
...
console.log('Smart email governor v84 préservé à travers entry-v33 : compte test protégé, cadence de 45 minutes, priorité selon état et suppression des messages obsolètes, avec Web TV ajoutée sans rupture de chaîne.');
