...
function uploadError(code){return({invalid_file_size:'Fichier trop volumineux.',unsupported_video_type:'Format vidéo non pris en charge.',upload_part_failed:'Une partie de la vidéo n’a pas pu être envoyée. Vérifiez votre connexion et recommencez.',upload_complete_failed:'Cloudflare n’a pas pu finaliser la vidéo.',studio_forbidden:'Votre session Studio a expiré.',origin_forbidden:'Import refusé pour des raisons de sécurité.',program_not_ready:'La vidéo est importée, mais le programme n’est pas prêt. Rechargez la page : elle restera dans la médiathèque.',upload_result_invalid:'La vidéo a été envoyée mais son adresse n’a pas pu être récupérée.'})[code]||`Import impossible (${code}).`;}
