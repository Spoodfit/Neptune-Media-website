...
const [entryV24, entryV25, entryV26, entryV27, entryV28, entryCurrent, store, governor, rootWrangler, nestedWrangler] = await Promise.all([
...
expect(entryCurrent, "from './entry-v28.js'", 'entry-v29 ne prolonge pas la chaîne v90 sans casser v84');
...
expect(rootWrangler, 'neptune-tv-media-cloudflare/src/entry-v29.js', 'le Worker racine ne cible pas le point d’entrée courant entry-v29');
expect(nestedWrangler, 'src/entry-v29.js', 'le Worker local ne cible pas le point d’entrée courant entry-v29');
...
console.log('Smart email governor v84 préservé à travers entry-v29 : compte test protégé, cadence de 45 minutes, priorité selon état et suppression des messages obsolètes.');
