...
expect('root Worker targets v39',rootWrangler.includes('neptune-tv-media-cloudflare/src/entry-v39.js'));
expect('local Worker targets v39',localWrangler.includes('src/entry-v39.js'));
...
console.log(`v119.1 final contract verified: ${checks.length} checks.`);
