...
['active v44 directly preserves v40, Drive v137/v138, v139 personalization and v142 runtime',rootWrangler.includes('neptune-tv-media-cloudflare/src/entry-v44.js')&&fs.lstatSync('neptune-tv-media-cloudflare/wrangler.jsonc').isSymbolicLink()&&workerWrangler===rootWrangler&&entry44.includes("from './entry-v40.js'")&&!entry44.includes("from './entry-v41.js'")&&!entry44.includes("from './entry-v42.js'")&&!entry44.includes("from './entry-v43.js'")&&entry44.includes('handleDriveManualValidationV138')&&entry44.includes('recoverDriveStagingUploadsV137')&&entry44.includes('handleHorsNormePersonalizationV139')&&entry44.includes('handleBusinessV142Store')&&entry44.includes('handleBusinessV142Http')&&entry44.includes('sendDuePreparationPacksV142')],
