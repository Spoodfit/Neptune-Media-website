...
const files = {
  ...
  runtime: await read('public/studio/studio-information-architecture-v65.js'),
...
check(files.runtime, 'primaryNavigationMarkup', 'la navigation principale canonique n’est pas construite');
...
console.log('Studio information architecture v65 verified: four primary destinations, contextual secondary tabs and shared readability layer.');
