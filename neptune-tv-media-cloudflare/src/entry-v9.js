...
function releaseResponse(request, env) {
  ...
  return new Response(JSON.stringify({
    ...
    clientWorkflowUi: 'workflow-v45-content-snapshot-v48-auth-safe-v18',
    clientVideoLibrary: 'passage-selector-horizontal-rails-4-long-8-short-v4',
    ...
    contentPreviewMode: 'single-dialog-on-demand-cleanup-safe',
    contentScrollModel: 'bounded-by-passage-horizontal-rails-and-pagination',
    ...
    responsiveAudit: 'client-and-studio-v18-runtime-contract',
