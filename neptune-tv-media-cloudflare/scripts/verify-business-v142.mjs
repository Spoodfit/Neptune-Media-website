...
['active v46 preserves v142 through v45 -> v44 while canonical Worker config mirrors root and v44 directly preserves v40, Drive v137/v138 and v139 personalization',rootWrangler.includes('neptune-tv-media-cloudflare/src/entry-v46.js')&&workerWrangler===rootWrangler&&entry46.includes("from './entry-v45.js'")&&entry45.includes("from './entry-v44.js'")&&entry44.includes("from './entry-v40.js'")&&!entry44.includes("from './entry-v41.js'")&&!entry44.includes("from './entry-v42.js'")&&!entry44.includes("from './entry-v43.js'")&&entry44.includes('handleDriveManualValidationV138')&&entry44.includes('recoverDriveStagingUploadsV137')&&entry44.includes('handleHorsNormePersonalizationV139')&&entry44.includes('handleBusinessV142Store')&&entry44.includes('handleBusinessV142Http')&&entry44.includes('sendDuePreparationPacksV142')],
