...
expect(root.main==='neptune-tv-media-cloudflare/src/entry-v39.js','le Worker racine doit cibler entry-v39');
expect(local.main==='src/entry-v39.js','le Worker local doit cibler entry-v39');
...
expect(activeEntry38.includes('client-experience-v117.js')&&activeEntry38.includes('client-command-center-v118-1.js'),'l’expérience client v118.2 n’est plus préservée sous v39');
...
console.log('WebTV v119 validée à travers entry-v39 : expérience client v118.2 et reprise v115 préservées, HLS Neptune principal, YouTube secondaire facultatif, import R2 et watchdog conservés.');
