const RELEASE='neptune-client-media-catalog-20260913-v95.1-visual-owner-aware';
...
function boot(){
  document.body.dataset.mediaCatalogRelease=RELEASE;
  if(visualOwned())return;
  mount();
  new MutationObserver(()=>requestAnimationFrame(mount)).observe(document.body,{childList:true,subtree:true});
}
