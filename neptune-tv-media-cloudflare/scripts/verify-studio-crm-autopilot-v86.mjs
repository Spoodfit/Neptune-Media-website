...
expect('root Worker targets entry-v27', rootWrangler.includes('neptune-tv-media-cloudflare/src/entry-v27.js'));
expect('local Worker targets entry-v27', localWrangler.includes('src/entry-v27.js'));
...
expect('CRM has two-hour message cooldown', crm.includes('MESSAGE_COOLDOWN_MS = 2 * 60 * 60 * 1000'));
