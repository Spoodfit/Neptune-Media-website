...
const RELEASE='neptune-client-experience-20260815-v118.6';
const DIRECT_BOOKING_RELEASE='neptune-client-direct-reservation-20260815-v118.5';
const CATALOG_INTERACTION_RELEASE='neptune-client-catalog-interaction-20260815-v118.6';
...
const CATALOG_INTERACTION_JS='/espace-client/client-catalog-interaction-v118-6.js?v=1';
...
async function injectClientExperience(response,pathname=''){
  ...
  body=body.replace(/<script\b[^>]*src=["'][^"']*\/espace-client\/(?:client-experience-v117|client-command-center-v118(?:-1)?|client-preparation-context-v118|client-passage-deeplink-v118|client-visual-coherence-v118-2|client-ux-v118-4|client-catalog-interaction-v118-6|client-calendar-chrome-v118-4-1)\.js[^"']*["'][^>]*>\s*<\/script>\s*/giu,'');
