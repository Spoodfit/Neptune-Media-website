  ...
  return (
    <header className="border-b border-border/80 bg-[#020611d1] backdrop-blur-xl">
      <div className="container-neptune flex min-h-[64px] items-center justify-between gap-3 sm:min-h-[70px] sm:gap-4">
        <Link href="#top" className="inline-flex shrink-0 items-center" aria-label="Neptune Media"><Image src="/assets/logo_neptune_blanc.png" alt="Neptune Business | Media" width={1136} height={341} className="h-8 w-auto max-w-none sm:h-9 md:h-10" style={{ width: "auto", aspectRatio: "1136 / 341" }} sizes="180px" priority /></Link>
