...
const [entryV24, entryV25, entryV26, entryV27, entryV28, entryV29, entryCurrent, store, governor, rootWrangler, nestedWrangler] = await Promise.all([
...
expect(entryCurrent, "from './entry-v29.js'", 'entry-v30 ne prolonge pas la chaîne v90 sans casser v84');
...
expect(rootWrangler, 'neptune-tv-media-cloudflare/src/entry-v30.js', 'le Worker racine ne cible pas entry-v30');
expect(nestedWrangler, 'src/entry-v30.js', 'le Worker local ne cible pas entry-v30');
...
console.log('Smart email governor v84 préservé à travers entry-v30 : compte test protégé, cadence de 45 minutes, priorité selon état et suppression des messages obsolètes.');
